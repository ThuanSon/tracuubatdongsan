...
const FullPost = () => {
  ...
  useEffect(() => {
    ...
    getProvince();
    // const idPro = formDataBatDongSan.province.PROVINCE_ID
    // console.log(idPro);
  ...
  const handleSubmitThongTinBatDongSan = async () =>
    // event: React.FormEvent<HTMLFormElement>
    {
      ...
      // Send formDataBatDongSan to your backend or perform any other action
      // console.log("Form Data:", formDataBatDongSan);
      const res = await axios.post(
  ...
  // const handleFetch = () => {
  //   if (formDataBatDongSan.province.PROVINCE_ID !== "") {
  //     fetchDistrict(formDataBatDongSan.province.PROVINCE_ID);
  //     console.log(quan);
  //   }
  // };
        ...
        <Grid container spacing={2} alignItems="center">
          <Grid item xs={12}>
            ...
            <OutlinedInput
              ...
              onChange={(event: any) => handleChangeThongTin(event, "dientich")}
            />
          </Grid>
          <Grid item xs={8}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={() => {
                ...
                // handleSubmitAnh();
                // console.log(2);
                // handleSubmitThongTinBatDongSan();
                // console.log(3);
                // handleSubmitPost();
                // console.log(4);
              }}
